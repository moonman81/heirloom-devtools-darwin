# INSTALL — make, sccs, yacc, lex, m4 (Heirloom Darwin port)
...
`uninstall` reads the manifest at `.install-manifest-devtools.txt`
...
`https://github.com/moonman81/heirloom-devtools-darwin/issues`
with:
