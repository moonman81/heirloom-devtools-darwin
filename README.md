# Heirloom Development Tools — macOS / Darwin port

A **downstream** Darwin (macOS 26 arm64) port of Gunnar Ritter's
Heirloom **Development Tools**, heirloom-devtools-070527 release.
...
- Commit 1 (`ae7d224`) — **pristine `heirloom-devtools-070527`** upstream tarball,
