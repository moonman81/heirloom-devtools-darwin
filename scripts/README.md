...
port scaffolding — bootstrap/configure/install/verify/uninstall/status/snapshot scripts.
...
- **Scripts**: bootstrap.sh, configure.sh, install-man.sh, snapshot.sh, status.sh, uninstall.sh, verify.sh, write-manifest.sh
