...
Lexical analyser generator, companion to yacc.
...
- **C sources**: allprint.c, getopt.c, header.c, ldefs.c, libmain.c, lsearch.c, main.c, reject.c, sub1.c, sub2.c, sub3.c, wcio.c (+2 more)
- **Headers**: heirloom_flags.h, once.h, search.h, sgs.h
