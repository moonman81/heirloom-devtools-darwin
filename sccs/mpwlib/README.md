...
MPW-style library used by the SCCS tools.
...
- **C sources**: abspath.c, any.c, cat.c, dname.c, fatal.c, fdfopen.c, fmalloc.c, getopt.c, had.c, imatch.c, index.c, lockit.c (+15 more)
