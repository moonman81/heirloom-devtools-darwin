...
historical texts that inform the `devtools` package (make, sccs, yacc, lex, m4) in
...
- Feldman, Stuart I. (1979). "Make - A Program for Maintaining
  Computer Programs." Software - Practice and Experience 9(4).
  Original make paper; heirloom-make traces its lineage directly.
- Rochkind, Marc J. (1975). "The Source Code Control System."
  IEEE Transactions on Software Engineering SE-1(4). The SCCS paper.
- Johnson, Stephen C. (1975). "Yacc: Yet Another Compiler-Compiler."
  Bell Labs Computing Science Technical Report No. 32. Foundation
  of the yacc utility this package ships.
- Lesk, M. E. and E. Schmidt (1975). "Lex - A Lexical Analyzer
  Generator." Bell Labs Computing Science Technical Report No. 39.
- Kernighan, Brian W. and Dennis M. Ritchie (1977). "The M4
  Macro Processor." Bell Labs Computing Science Technical Report
  No. 59.
