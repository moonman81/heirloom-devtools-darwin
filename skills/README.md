...
port-authoring skills used by AI-assisted maintenance.
...
- **Subdirs**: bell-labs-lex-yacc-bootstrap, heirloom-non-authoritative-downstream-port, heirloom-per-file-license-patchwork, heirloom-port-alm-lifecycle
